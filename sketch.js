...
/*function reset(){
 gameState=END
  ...
  shrubsElement.destroyEach();
  score = score+10;
  function keyReload (){
  this.addAnimation("kangaroo")
  kangaroo.position.y=kangaroo.position.y=+5
  kangaroo.position.x=kangaroo.position.x=-10
  if(mousePrssedOver){
